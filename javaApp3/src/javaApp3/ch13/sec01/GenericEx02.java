...
class Course{
	...
	public static void registerCourse2(Applicant<? extends Student> applicant) { //학생만 등록
		
		//<? extends Student> student 객체를 포함해 자식만
		System.out.println(applicant.kind.getClass().getSimpleName() + "이(가) Course2을 등록함.");
	}
	
	public static void registerCourse3(Applicant<? super Worker> applicant) { //직장인 및 일반인만 등록
		
		//<? super Worker> worker 객체를 포함해 상위객체만
